...
const Footer = () => {
  ...
  return (
    <div className='px-36 py-10 bg-[#3525C3] text-white'>
        ...
        <hr className='mt-7'/>
        <h1 className='font-extralight mt-2'>Copyright © 2025 Pamantasang Lungsod ng Muntinlupa Chorale. All Rights Reserved</h1>
    </div>
  )
}
